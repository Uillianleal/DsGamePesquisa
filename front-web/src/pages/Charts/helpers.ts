...
export const buildBarSeries = (games: Game[], records: Records[]) => {
...
export const getPlatformChartData = (records: Records[]) => {
...
export const getGenderChartData = (records: Records[]) => {
